...
export function formatJupiterPriceImpact(priceImpactRatio: number | null): string {
...
export function fullJupiterPriceImpact(priceImpactRatio: number | null): string | undefined {
