/**
 * Port of `convex/adminAuth.ts` (copied from `apps/cloudrun-admin/src/adminAuth.ts`).
 *
...
import { IdentityRequiredError, UnauthorizedError, type CallerIdentity } from './handlers/assets';
