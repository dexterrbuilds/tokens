            ...
            {hasSelected && (
                <div className="pointer-events-none fixed bottom-8 left-0 right-0 z-50 flex justify-center px-4">
                    <motion.div
                        ...
                        className="pointer-events-auto flex h-[56px] w-[400px] max-w-[calc(100vw-2rem)] items-center rounded-[20px] bg-zinc-800 p-1 shadow-[0_3px_8px_rgba(0,0,0,0.2),0_2px_4px_rgba(0,0,0,0.1)]"
                    >
                        <div className="flex h-full w-full items-center justify-between px-2">
                            ...
                            <div className="flex items-center gap-2">
                                <Button
                                    ...
                                    variant="destructive"
                                    size="sm"
                                    className="h-7 rounded-[10px] px-2 !pr-3 text-xs"
                                >
                                    {isRemoving ? (
                                        ...
                                        <span className="flex items-center gap-1">
                                            <IconTrashFill className="h-3 w-3 fill-white" />
                                            Remove
                                        </span>
                                    )}
                                </Button>
                                <Button
                                    ...
                                    variant="ghost"
                                    size="sm"
                                    className="h-7 rounded-[10px] px-2 text-xs text-zinc-300 hover:bg-white/10 hover:text-white"
                                >
                                    Cancel
                                </Button>
                            </div>
